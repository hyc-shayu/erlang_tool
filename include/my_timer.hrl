...
-define(TIMER_TAB, list_to_atom(?STR_MODULE ++ "_tab")).
% -define(TIMER_TAB, my_timer_tab).
-define(INTERVAL_TAB, list_to_atom(?STR_MODULE ++ "_interval_tab")).
% -define(INTERVAL_TAB, my_timer_interval_tab).
-define(TIMER_SERVER, list_to_atom(?STR_MODULE ++ "_server")).
